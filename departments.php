    ...
    switch( $post->post_type ) {
        ...
        case 'classroom':
            $content = "Course title: <br>
						...
						<li>Fourth, clearly describe how your performance was measured in the course. Include any papers, tests, and other documents that demonstrate what you learned in this class. Insert these documents using the Upload/Insert -> From Scribd feature directly above this text box.</li>
